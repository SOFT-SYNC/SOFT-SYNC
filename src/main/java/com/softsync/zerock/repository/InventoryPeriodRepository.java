...
public interface InventoryPeriodRepository extends JpaRepository<InventoryPeriod, Long> {
    ...
    @Query("SELECT new com.softsync.zerock.DTO.InventoryPeriodSummaryDTO(" +
           ...
           "FROM InventoryPeriod ip2 " +
           "LEFT JOIN ip2.shipmentList sl2 " +
           "LEFT JOIN ip2.receiveList rl2 " +
           ...
           "FROM InventoryPeriod ip3 " +
           "LEFT JOIN ip3.shipmentList sl3 " +
           "LEFT JOIN ip3.receiveList rl3 " +
           ...
           "LEFT JOIN ip.shipmentList sl " +
           "LEFT JOIN ip.receiveList rl " +
           "LEFT JOIN rl.receiving r " +
    ...
    List<InventoryPeriodSummaryDTO> findInventoryPeriodSummaries(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
